...
insert into album (singer_id, title, release_date) values (1, 'The searxh for everything', '2017-01-20');
insert into album (singer_id, title, release_date) values (2, 'Buttle staudies', '2009-11-17');
